...
def run(args=None):
    parser = argparse.ArgumentParser(
        prog="MicroSynViz TE_Annotator",
        description="TE_Annotator: (description to be added)"
    )
    # TODO: add arguments
    ...
    print(f"[MicroSynViz] Running TE_Annotator (implementation coming soon)")
